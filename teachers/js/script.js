...
function addquiztodb() {
  ...
  // add quiz
  var theUrl1 = "../response.php?cmd=11&quiz=" + id + "&teacher=" + currentuser + "&cat=" + quizcategory;
  // add questions
  var theUrl2 = "../response.php?cmd=15&quiz=" + id + "&questiontext=" + question1[0] + "&a=" + question1[1] + "&b=" + question1[2] + "&c=" + question1[3] + "&d=" + question1[4] + "&ans=" + question1[5];
  var theUrl3 = "../response.php?cmd=15&quiz=" + id + "&questiontext=" + question2[0] + "&a=" + question2[1] + "&b=" + question2[2] + "&c=" + question2[3] + "&d=" + question2[4] + "&ans=" + question2[5];
  var theUrl4 = "../response.php?cmd=15&quiz=" + id + "&questiontext=" + question3[0] + "&a=" + question3[1] + "&b=" + question3[2] + "&c=" + question3[3] + "&d=" + question3[4] + "&ans=" + question3[5];
  var theUrl5 = "../response.php?cmd=15&quiz=" + id + "&questiontext=" + question4[0] + "&a=" + question4[1] + "&b=" + question4[2] + "&c=" + question4[3] + "&d=" + question4[4] + "&ans=" + question4[5];
  var theUrl6 = "../response.php?cmd=15&quiz=" + id + "&questiontext=" + question5[0] + "&a=" + question5[1] + "&b=" + question5[2] + "&c=" + question5[3] + "&d=" + question5[4] + "&ans=" + question5[5];
...
function getcategories() {
  ...
  var theUrl = "../response.php?cmd=10&teacher=" + currentuser;
...
function getquiz(quiz) {
  ...
  var theUrl = "../response.php?cmd=16&quiz=" + quiz;
  var obj = sendRequest(theUrl); //send request to the above url
...
function listquizzes(category) {
  ...
  var theUrl = "../response.php?cmd=26&teacher=" + currentuser + "&category=" + category;
  var obj = sendRequest(theUrl); //send request to the above url
  if (obj.result == 1) { //check result
