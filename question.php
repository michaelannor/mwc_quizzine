...
class question extends adb {
   ...
   */
    function add_question($quiz, $questiontext, $a, $b, $c, $d, $answer){
      $str_query="insert into mwc_quizzine_question set quiz_id='$quiz', question_text='$questiontext', option_a='$a',
     ...
     */
      function get_questions_by_quiz($quiz){
        $str_query="select * from mwc_quizzine_question where quiz_id='$quiz'";
       ...
       */
        function get_answer($question){
          $str_query="select answer from mwc_quizzine_question where question_id='$question'";
            if(!$this->query($str_query)){
                return false;
            }
            return $this->fetch();
